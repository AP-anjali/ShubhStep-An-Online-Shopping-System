...
@section('title')
<title>New Return Requests</title>
@endsection
...
@section('body')
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4>New Return Requests</h4>
                  </div>
                  <div class="card-body">
                    
                    @if(isset($allReturnRequests))
                        @if(count($allReturnRequests) > 0)
                            <div class="table-responsive">
                                <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                    ...
                                    @foreach($allReturnRequests as $eachOrder)
    ...
    <script>
        function addModal(OrderID) 
        {
            ...
            var AcceptUrl = "{{ route('accepting_return_request', ':id') }}"; 

            AcceptUrl = AcceptUrl.replace(':id', OrderId);

            swal({
            title: 'Are you sure?',
            text: 'Are you sure to accept this return request !',
            icon: 'warning',
            buttons: true,
            dangerMode: true,
            })
