...
@section('body')
              ...
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    @if(isset($allAcceptedOrders))
                        @if(count($allAcceptedOrders) > 0)
                            <div class="table-responsive">
                                <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                    ...
                                    <tr>
                                        ...
                                        <th style="vertical-align: middle;">Mark As Ready</th>
                                    ...
                                    @foreach($allAcceptedOrders as $eachOrder)
    ...
    <script>
        function addModal(OrderID) {
            ...
            var AcceptUrl = "{{ route('undo_order_acceptance', ':id') }}"; 

            AcceptUrl = AcceptUrl.replace(':id', OrderId);

            swal({
            title: 'Are you sure?',
            text: 'Are you sure to undo the acceptance of this order !',
            icon: 'warning',
            buttons: true,
            dangerMode: true,
            })
        ...
        function addModal2(OrderID) {
            ...
            var AcceptUrl = "{{ route('mark_order_as_ready', ':id') }}"; 

            AcceptUrl = AcceptUrl.replace(':id', OrderId);

            swal({
            title: 'Are you sure?',
            text: 'Are you sure to mark this order as ready !',
            icon: 'warning',
            buttons: true,
            dangerMode: true,
            })
