...
@section('title')
<title>New Requests For Return</title>
@endsection
                            ...
                            <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                ...
                                @foreach($orders_data as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->requested_for_return_date }}</td>

                                        <td>
                                            @if(($data->is_request_for_return_accepted) == NULL)
                                                Pending
                                            @elseif(($data->is_request_for_return_accepted == 1) && ($data->is_return_completed == 0))
                                                Accepted
                                            @elseif(($data->is_return_completed == 1))
                                                Returned
                                            @endif                                            
                                        </td>
...
@section('script')
  <script>
    ...
    function addModal2(OrderID) {
        ...
        var AcceptUrl = "{{ route('canceling_return_request') }}"; 

        swal({
        title: 'Are you sure?',
        text: 'Are you sure to cancel the return request of this order !',
        icon: 'warning',
        buttons: true,
        dangerMode: true,
        })
