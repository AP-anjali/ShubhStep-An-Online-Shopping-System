                            ...
                            <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                ...
                                @foreach($orders_data as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->return_completed_date }}</td>

                                        <td>
                                            @if(($data->is_payment_refunded_for_return) == 1)
                                                Refunded
                                            @else   
                                                Pending
                                            @endif                                            
                                        ...
                                        <td>{{ $data->payment_refunded_for_return_date ? $data->payment_refunded_for_return_date : '-----' }}</td>
