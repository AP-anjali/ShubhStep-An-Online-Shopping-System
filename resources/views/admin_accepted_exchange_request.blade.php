...
@section('body')
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4>Accepted Exchange Orders</h4>
                  </div>
                  <div class="card-body">
                    
                    @if(isset($AcceptedExchangeRequests))
                        @if(count($AcceptedExchangeRequests) > 0)
                            <div class="table-responsive">
                                <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                    ...
                                    <tr>
                                        ...
                                        <th style="vertical-align: middle;">Mark As Exchanged</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    @foreach($AcceptedExchangeRequests as $eachOrder)
    ...
    <script>
        function addModal(OrderID) 
        {
            ...
            var AcceptUrl = "{{ route('undo_order_exchange_request_acceptance', ':id') }}"; 

            AcceptUrl = AcceptUrl.replace(':id', OrderId);

            swal({
            title: 'Are you sure?',
            text: "Are you sure to undo the acceptance of this order's exchange request !",
            icon: 'warning',
            buttons: true,
            dangerMode: true,
            })
        ...
        function addModal2(OrderID) 
        {
            ...
            var AcceptUrl = "{{ route('send_otp_to_customer_for_exchange_verification', ':id') }}"; 

            AcceptUrl = AcceptUrl.replace(':id', OrderId);

            swal({
            title: 'Are you sure?',
            text: "Are you sure to mark this request as exchnaged !",
            icon: 'warning',
            buttons: true,
            dangerMode: true,
            })
