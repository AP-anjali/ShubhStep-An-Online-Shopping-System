...
<body>
    <div class="container">
        <div class="header">
            <h1>OTP For E-mail Verification From "SHUBHSTEP"</h1>
        </div>
        <div class="content">
            <h2>Dear Admin !</h2>
            <p class = "texxt">Your OTP for email verification is:</p>
            <h2 style = "font-size : 1.7rem; text-align : center; margin-top: 0;">{{ $OTP }}</h2>
            <p class = "texxt" style = "text-align: justify;">Please use this OTP to verify yourself and get further access to change your details. If you did not request this OTP, please ignore this email.</p>
