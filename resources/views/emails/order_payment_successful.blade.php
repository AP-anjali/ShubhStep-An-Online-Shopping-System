...
<body>
    <div class="container">
        <div class="header">
            <h1>Payment Successful Mail From "SHUBHSTEP"</h1>
        </div>
        <div class="content">
            <h2>Dear {{ $customer->name }}!</h2>
            <p class = "texxt">Your order payment has been successfully processed, and it will be delivered in the next 5 to 6 days.</p>
