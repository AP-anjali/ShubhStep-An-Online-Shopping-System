...
<body>
    <div class="container">
        <div class="header">
            <h1>OTP For Order Returned Verification From "SHUBHSTEP"</h1>
        </div>
        <div class="content">
            <h2>Dear Customer !</h2>
            <p class = "texxt">Your OTP for order returned verification is :</p>
            <h2 style = "font-size : 1.7rem; text-align : center; margin-top: 0;">{{ $OTP }}</h2>
            <p class = "texxt" style = "text-align: justify;">Please use this OTP to verify the successful return of your order. If you did not request this OTP, please ignore this email.</p>
