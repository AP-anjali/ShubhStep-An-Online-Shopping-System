...
@section('body')
                        ...
                        @if(count($allNewOrders) > 0)
                            <div class="table-responsive">
                                <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                    ...
                                    @foreach($allNewOrders as $eachOrder)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" onclick = "addModal({{ $eachOrder->id }})" class="btn btn-primary" style="background-color: #00ab41;">Accept</button>
                                                <button type="button" onclick = "addModal2({{ $eachOrder->id }})" class="btn btn-primary mt-2" style="background-color: #FF474C;">Reject</button>
                                            </td>
    ...
    <script>
        function addModal(OrderID) {
            ...
            var AcceptUrl = "{{ route('accepting_order', ':id') }}"; 
        ...
        function addModal2(OrderID) {
            ...
            var AcceptUrl = "{{ route('order_reject_reason_form') }}"; 
