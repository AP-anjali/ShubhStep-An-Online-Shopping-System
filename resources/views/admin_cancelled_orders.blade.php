              ...
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    @if(isset($allCancelledOrders))
                        @if(count($allCancelledOrders) > 0)
                            <div class="table-responsive">
                                <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                    ...
                                    <tr>
                                        ...
                                        <th style="vertical-align: middle;">Cancelled Date</th>
                                        <th style="vertical-align: middle;">Cancellation Reason</th>
                                    ...
                                    @foreach($allCancelledOrders as $eachOrder)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $eachOrder->order_cancelled_date }}</td>    
                                            <td>{{ $eachOrder->order_cancel_reason }}</td>    
