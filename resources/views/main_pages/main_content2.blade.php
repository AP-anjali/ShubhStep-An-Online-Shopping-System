              ...
              <div class="showcase-container">
                ...
                <div class="showcase">
                  ...
                  <div class="showcase-content">
                    ...
                    <div style = "display : flex; gap : 5%; text-align : center; align-items : center; justify-content: center;">
                        @if(isset($userCartProducts))
                            @if(in_array($product_data->id, $userCartProducts))
                                <button class="add-cart-btn" onclick = "window.location.href = '/customer-cart'">go to cart</button>
                            @else
                                <button class="add-cart-btn" onclick = "openCart2()">add to cart</button>
                            @endif
                        @else
                            <button class="add-cart-btn" onclick = "openCart2()">add to cart</button>
                        @endif
                        ...
                        @if(isset($userWishlistProducts))
                            @if(in_array($product_data->id, $userWishlistProducts))
                                <button class="add-cart-btn" onclick = "window.location.href = '/customer-wishlist'">go to wishlist</button>
                            @else
                                <button class="add-cart-btn" onclick = "openWhishlist2()">add to wishlist</button>
                            @endif
                        @else
                            <button class="add-cart-btn" onclick = "openWhishlist2()">add to wishlist</button>
                        @endif

                        <button class="add-cart-btn" onclick = "openBuyNow2()">Buy Now</button>
                    </div>

                        <div class="modal closed" id="wishlist_pop_up" data-modal>
                        ...
                        <div class="modal closed" id="cart_pop_up" data-modal2>
                              ...
                              <div class="newsletter">
                                ...
                                <form action="{{ route('add_to_cart') }}" method = "post">
                                  ...
                                  @csrf
                                    ...
                                    <input type="hidden" name="product_id" value = "{{ $product_data->id }}">
                                    <input type="hidden" name="product_price_without_discount" value = "{{ $product_data->price_without_discount }}">
                                    <input type="hidden" name="product_price_with_discount" value = "{{ $product_data->price_with_discount }}">
                        ...
                        <div class="modal closed" id="buy_now_pop_up" data-modal3>
