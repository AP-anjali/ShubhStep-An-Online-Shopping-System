              ...
              <div class="container_anjali">
                ...
                <div class="form_anjali">
                  <div class="contact-info_anjali">
                    <h3 class="title_anjali">Tell Us How We Did !</h3>
                    <hr>
                    ...
                    <p class="text_anjali" style="margin-top: 0.5rem; text-align: center;">
                        Let us know how we're doing and how we can serve you better.
                    </p>
              
                    <p class="text_anjali" style="text-align: justify;">
                      We appreciate your input to help us enhance our services. Your feedback is crucial for our growth and improvement. We are eager to hear your thoughts and suggestions.
                    </p>
                  ...
                  <div class="contact-form_anjali">
                    ...
                    <form action="{{ route('feedback_form_submit') }}" method = "post" autocomplete="off">
                      @csrf
                      <h3 class="title_anjali">Feedback Form</h3>
                      ...
                      <div class="input-container_anjali">
                        <select name="start_rating" id="mySelect" class="input2 star-rating" required>
