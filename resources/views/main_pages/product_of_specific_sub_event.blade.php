    ...
    <div class="product-container">
      ...
      <div class="container">
        ...
        <div class="product-box" style = "width : 100%;">
          ...
          <div class="product-main" style = "margin-top : 1%;">

            <h2 class="title"  style = "border-top: 1px solid hsl(0, 0%, 93%); padding-top: 0.5rem;" id = "forScollPosition">{{ $sub_event_data->event->event_name }} | {{ $sub_event_data->sub_event_name }}</h2> 
            ...
            @if(isset($subEventProducts))
              @if(count($subEventProducts) > 0)
                <div class="product-grid">
                    @foreach($subEventProducts as $eachProduct)
              ...
              @else
                <h3 class="showcase-heading" style = "color : hsl(0, 0%, 27%); text-align : center;">No any product uploaded yet, for this event !</h3>
              @endif
            @endif
