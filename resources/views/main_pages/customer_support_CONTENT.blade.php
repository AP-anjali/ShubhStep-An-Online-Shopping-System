              ...
              <div class="container_anjali">
                ...
                <div class="form_anjali">
                  <div class="contact-info_anjali">
                    <h3 class="title_anjali">How Can We Help You ?</h3>
                    <hr>
                    ...
                    <p class="text_anjali" style="text-align: justify;">
                      Whether you have any question or problem about your order, our products, or anything else, our team is ready to answer all your questions. 
                    </p>
                  ...
                  <div class="contact-form_anjali">
                    ...
                    <form action="{{ route('customer_support_form_submit') }}" method = "post" autocomplete="off">
                      @csrf
                      <h3 class="title_anjali">Customer Support</h3>
