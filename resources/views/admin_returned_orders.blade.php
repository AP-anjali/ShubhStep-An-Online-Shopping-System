                        ...
                        @if(count($ReturnedOrders) > 0)
                            <div class="table-responsive">
                                <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                    ...
                                    @foreach($ReturnedOrders as $eachOrder)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $eachOrder->return_completed_date }}</td>    
                                            ...
                                            <td>
                                                ...
                                                @if($eachOrder->is_payment_refunded_for_return == 1)
                                                    Refunded
                                                @else
                                                    Pending
                                                @endif
                                            ...
                                            <td>
                                                {{ $eachOrder->payment_refunded_for_return_date ? $eachOrder->payment_refunded_for_return_date : '-----';}}
                                            </td>
