      ...
      <div class="section-body">
        <div class="row">
            <div class="col-md-12" style = "margin : auto;">
                ...
                <form method = "post" action = "{{ route('updating_product', $product_to_update->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input style="font-weight: 600;" type="text" class="form-control" value="{{ $product_to_update->product_name }}" name="product_name" placeholder="Enter product name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Product Title</label>
                                    <input style="font-weight: 600;" type="text" class="form-control" value="{{ $product_to_update->product_title }}" name="product_title" placeholder="Enter product title" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="font-weight: 600;" class="form-control" name="product_description" value="{{ old('product_description') }}" placeholder="Enter product description" required>{{ $product_to_update->product_description }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input style="font-weight: 600;" min = "1" type="number" class="form-control" name="price_without_discount" value="{{ $product_to_update->price_without_discount }}" placeholder="Product price without discount" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Price With Discount</label>
                                    <input style="font-weight: 600;" min = "1" type="number" class="form-control" name="price_with_discount" value="{{ $product_to_update->price_with_discount }}" placeholder="Product price with discount" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Product Quantity</label>
                                    <input style="font-weight: 600;" type="number" class="form-control" name="product_quantity" value="{{ $product_to_update->product_quantity }}" placeholder="Product Quantity" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Product Thumbnail Image [Nullable]</label>
                                <div class="custom-file">
                                    <input type="file" style="font-weight: 600;" class="custom-file-input" name="thumbnail_image" id="thumbnail_image_tag" style = "cursor : pointer;">
                            ...
                            <div class="form-group col-md-6">
                                <label>Product Other Images [Multiple images allowed] [Nullable]</label>
                                <div class="custom-file">
                                    <input type="file" style="font-weight: 600;" class="custom-file-input" multiple name="other_images[]" id="other_image_tag" style = "cursor : pointer;">
...
<script>
    ...
    function populateRealSubEvents() {
        var eventId = document.getElementById('event_id').value;
        var subEventSelect = document.getElementById('sub_event_id');
        subEventSelect.innerHTML = '';

        let productSubEventID = @json($product_to_update->sub_event_id);
            ...
            if ({{ $event->id }} == eventId) 
            {
                ...
                @if(count($event->subEvents) > 0)
                    @foreach($event->subEvents as $subEvent)
                        ...
                        option.value = "{{ $subEvent->id }}";
                        option.textContent = "{{ $subEvent->sub_event_name }}";
                        if("{{ $subEvent->id }}" == productSubEventID)
                        {
    ...
    document.addEventListener('DOMContentLoaded', populateRealSubEvents);
</script>
@endsection
