...
@section('title')
<title>Accepted Return Orders</title>
@endsection
...
@section('body')
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4>Accepted Return Orders</h4>
                  </div>
                  <div class="card-body">
                    
                    @if(isset($AcceptedReturnRequests))
                        @if(count($AcceptedReturnRequests) > 0)
                            <div class="table-responsive">
                                <table class="table table-striped gfg" id="table-1" style = "text-align : center;">
                                    ...
                                    <tr>
                                        ...
                                        <th style="vertical-align: middle;">Return Request Date</th>
                                        <th style="vertical-align: middle;">Return Request Reason</th>
                                        <th style="vertical-align: middle;">Request Accepted Date</th>
                                        <th style="vertical-align: middle;">Customer Details</th>
                                        <th style="vertical-align: middle;">Undo Acceptance</th>
                                        <th style="vertical-align: middle;">Mark As Returned</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    @foreach($AcceptedReturnRequests as $eachOrder)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $eachOrder->requested_for_return_date }}</td>    
                                            <td>{{ $eachOrder->return_request_reason }}</td>    
                                            <td>{{ $eachOrder->request_for_return_accepted_date }}</td>    
    ...
    <script>
        function addModal(OrderID) 
        {
            ...
            var AcceptUrl = "{{ route('undo_order_return_request_acceptance', ':id') }}"; 

            AcceptUrl = AcceptUrl.replace(':id', OrderId);

            swal({
            title: 'Are you sure?',
            text: "Are you sure to undo the acceptance of this order's return request !",
            icon: 'warning',
            buttons: true,
            dangerMode: true,
            })
        ...
        function addModal2(OrderID) 
        {
            ...
            var AcceptUrl = "{{ route('send_otp_to_customer_for_return_verification', ':id') }}"; 

            AcceptUrl = AcceptUrl.replace(':id', OrderId);

            swal({
            title: 'Are you sure?',
            text: "Are you sure to mark this request as returned !",
            icon: 'warning',
            buttons: true,
            dangerMode: true,
            })
